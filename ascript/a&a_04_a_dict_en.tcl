...
set say(lang.1.46)    "FAILED: the nick length for user %b«%% is bigger than supported (max allowed $handlen characters). Contact please %B$settings(homepage)"
set say(lang.1.47)    ""
...
set say(lang.1.527)   ""
set say(lang.1.528)   ""
set say(lang.1.529)   "USAGE: «ignore \[-remove|-list|-add\] <\$host> \[\$duration\] \[\$reason\] «"
...
set say(lang.1.538)   "USAGE: «ban <\$nick|\$host> \[\$duration\] \[sticky\] \[global\] \[\$reason\] «"
...
set say(lang.1.558)   "USAGE: «xkick <\$nick> \[\$reason]\ «"
...
set say(lang.1.597)   "USAGE: «botstatus «"
...
set say(lang.1.601)   "USAGE: «cycle \[\$duration\] «"
